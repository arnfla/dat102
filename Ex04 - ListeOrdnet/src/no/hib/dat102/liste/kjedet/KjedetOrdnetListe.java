...
public class KjedetOrdnetListe<T extends Comparable<T>> implements OrdnetListeADT<T> {
	...
	public void leggTil(T element) {
		...
		if (antall == 0) { //Hvis mengden er tom og vi skal sette inn den foerste noden
			foerste = ny;
			siste = ny;
		} else if (forrige == null) { //Setter inn det foerste elementet i mengden, men det er noder i mengden
			foerste = ny;
			ny.setNeste(denne);
