...
public interface MengdeADT<T> {
	...
	/**
	 * Finner elementer som eksisterer i m1 og m2
	 * 
	 * @param m2
	 * 				mengde som skal "snittes"
	 * @return elementer som er i m1 og m2
	 */
	public MengdeADT<T> snitt(MengdeADT<T> m2);
	
	/**
	 * Finner elementer som er i m1, men ikke i m2
	 * 
	 * @param m2
	 * 				mengde som skal "taes ut"
	 * @return elementer som er i m1, men ikke i m2
	 */
